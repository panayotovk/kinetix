...
sealed class EodPromotionException(message: String) : RuntimeException(message) {
    ...
    class ConflictingOfficialEod(bookId: String, valuationDate: String) :
        EodPromotionException("An Official EOD already exists for portfolio $bookId on $valuationDate")
