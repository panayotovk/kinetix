package com.kinetix.regulatory.testing
...
/**
 * In-process Ktor HTTP server harness for regulatory-service acceptance tests.
 ...
 *
 * Equivalent in spirit to the gRPC fake-server pattern: the service's real
 * HTTP client calls a real HTTP server, so serialisation, content negotiation,
 * and HTTP wire behaviour are all exercised.
 *
